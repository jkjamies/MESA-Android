 ...
 *
 * Unlike [kotlinx.coroutines.TimeoutCancellationException], this is a [StrataException]
 * and is captured as [StrataResult.Failure] rather than propagating as a cancellation.
 */
